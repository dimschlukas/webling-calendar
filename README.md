...
- 🎯 Entry points to execute your program using `python -m <webling_calendar>` or `$ webling_calendar` with basic CLI argument parsing.
...
Awesome webling_calendar created by dimschlukas
